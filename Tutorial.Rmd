...
--> review if we should use this function or the iadbstats function
```{r}
...
We are going to create a new column in that DataFram named **Percentage**, transforming the values of **AggregatedValue** into numbers.
